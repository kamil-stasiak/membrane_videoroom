defmodule Videoroom.Room do
  ...
  defp filter_codecs(%Membrane.WebRTC.Track.Encoding{name: "H264", format_params: fmtp}) do
    import Bitwise
  ...
  defp filter_codecs(%{name: "opus"}), do: true
  defp filter_codecs(_mapping), do: false
